...
void write_7seg_digit(uint32_t offset, uint8_t digit) {
    switch (digit) {
        case 0x0:
            write_7seg(offset, SEG7_0);
            break;
        case 0x1:
            write_7seg(offset, SEG7_1);
            break;
        case 0x2:
            write_7seg(offset, SEG7_2);
            break;
        case 0x3:
            write_7seg(offset, SEG7_3);
            break;
        case 0x4:
            write_7seg(offset, SEG7_4);
            break;
        case 0x5:
            write_7seg(offset, SEG7_5);
            break;
        case 0x6:
            write_7seg(offset, SEG7_6);
            break;
        case 0x7:
            write_7seg(offset, SEG7_7);
            break;
        case 0x8:
            write_7seg(offset, SEG7_8);
            break;
        case 0x9:
            write_7seg(offset, SEG7_9);
            break;
        case 0xA:
            write_7seg(offset, SEG7_A);
            break;
        case 0xB:
            write_7seg(offset, SEG7_B);
            break;
        case 0xC:
            write_7seg(offset, SEG7_C);
            break;
        case 0xD:
            write_7seg(offset, SEG7_D);
            break;
        case 0xE:
            write_7seg(offset, SEG7_E);
            break;
        case 0xF:
            write_7seg(offset, SEG7_F);
            break;
        default:
            write_7seg(offset, 0x00);
            break;  // Turn off the segment
    }
}
...
void write_7seg_buf_digit(uint32_t offset, uint8_t digit) {
    switch (digit) {
        case 0x0:
            seg7_buf[offset] = SEG7_0;
            break;
        case 0x1:
            seg7_buf[offset] = SEG7_1;
            break;
        case 0x2:
            seg7_buf[offset] = SEG7_2;
            break;
        case 0x3:
            seg7_buf[offset] = SEG7_3;
            break;
        case 0x4:
            seg7_buf[offset] = SEG7_4;
            break;
        case 0x5:
            seg7_buf[offset] = SEG7_5;
            break;
        case 0x6:
            seg7_buf[offset] = SEG7_6;
            break;
        case 0x7:
            seg7_buf[offset] = SEG7_7;
            break;
        case 0x8:
            seg7_buf[offset] = SEG7_8;
            break;
        case 0x9:
            seg7_buf[offset] = SEG7_9;
            break;
        case 0xA:
            seg7_buf[offset] = SEG7_A;
            break;
        case 0xB:
            seg7_buf[offset] = SEG7_B;
            break;
        case 0xC:
            seg7_buf[offset] = SEG7_C;
            break;
        case 0xD:
            seg7_buf[offset] = SEG7_D;
            break;
        case 0xE:
            seg7_buf[offset] = SEG7_E;
            break;
        case 0xF:
            seg7_buf[offset] = SEG7_F;
            break;
        default:
            seg7_buf[offset] = 0x00;
            break;  // Turn off the segment
    }
}
...
void gameDraw() {
    ...
    for (int i = 0; i < 4; i++) {
        for (int j = 0; j < 16; j++) {
            if (((bulletA[i] >> j) & 1) == 1)
                seg7_buf[i * 16 + (15 - j)] = 0x02;
            else if (((bulletB[i] >> j) & 1) == 1)
                seg7_buf[i * 16 + (15 - j)] = 0x02;
            else
                seg7_buf[i * 16 + (15 - j)] = 0x00;
        }
    }
    if (AY == 0)
        write_7seg_buf_digit(0, 0);
    else if (AY == 1)
        write_7seg_buf_digit(16, 0);
    else if (AY == 2)
        write_7seg_buf_digit(32, 0);
    else if (AY == 3)
        write_7seg_buf_digit(48, 0);
    if (BY == 0)
        write_7seg_buf_digit(15, 0);
    else if (BY == 1)
        write_7seg_buf_digit(31, 0);
    else if (BY == 2)
        write_7seg_buf_digit(47, 0);
    else if (BY == 3)
        write_7seg_buf_digit(63, 0);
}
...
int main() {
    ...
    while (true) {
        if (gameState == TITLE) {
            ...
            if (lifeA < 0)
                display_left_lose_right_win();
            else if (lifeB < 0)
                display_left_win_right_lose();
